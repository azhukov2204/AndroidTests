...
class MainActivityEspressoTest {
    ...
    fun activitySearch_IsWorking() {
        ...
        onView(withId(R.id.searchEditText)).perform(replaceText(SEARCH_QUERY), closeSoftKeyboard())
        onView(withId(R.id.searchEditText)).perform(pressImeActionButton())
        onView(isRoot()).perform(delay())
        onView(withId(R.id.totalCountTextView)).check(matches(withText(EXPECTED_SEARCHED_STRING)))
    }
